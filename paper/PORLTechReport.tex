...
\subsubsection{Difference in Belief States}
...
\subsubsection{Approximate Belief Tracking}
...
\subsubsection{What happens when the minimum entry in the observation matrix is 0}
...
\subsubsection{Main Theorem with actions}
...
\subsubsection{POMDP as MDP over histories in an Episodic Task}
